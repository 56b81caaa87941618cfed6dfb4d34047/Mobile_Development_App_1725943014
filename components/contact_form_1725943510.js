<template>
  <main class="flex justify-center align-center p-10">
    <div class="w-fit max-w-lg p-8 bg-white shadow-lg rounded-lg">
      <div>
        <h3 class="text-black font-semibold text-xl">Let's Build Your Mobile App Together</h3>
        <p class="mt-3 text-black w-fit">Tell us about your project and we'll get back to you within 24 hours</p>
      </div>
      <form @submit.prevent class="space-y-5 mt-5">
        ...
        <div>
          <label class="font-medium text-black">Estimated Budget</label>
          <textarea
            required
